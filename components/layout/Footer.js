        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm text-vintage-cream/80">
              <li><Link href="/shop" className="hover:text-white transition-colors">{t.shopAll}</Link></li>
              <li><Link href="/shop?sort=newest" className="hover:text-white transition-colors">{t.newArrivals}</Link></li>
              <li><Link href="/shop?sort=bestSellers" className="hover:text-white transition-colors">{t.bestSellers}</Link></li>
              <li><Link href="/blog" className="hover:text-white transition-colors">{t.journal}</Link></li>
            </ul>
          </div>
